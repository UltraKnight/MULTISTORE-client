        ...
        <div className='col-md-6 offset-md-3'>
            ...
            <div id="carouselHighlights" className="carousel slide" data-bs-ride="carousel">
                ...
                <div className="carousel-inner">
                    ...
                    <Link to={`/products/${highlights[0]._id}`}><img src={highlights[0].image_url} className="d-block w-50 mx-auto" alt={highlights[0].name} /></Link>
                    ...
                    <Link to={`/products/${highlights[1]._id}`}><img src={highlights[1].image_url} className="d-block w-50 h-25 mx-auto" alt={highlights[1].name} /></Link>
                        <div className="carousel-caption d-none d-md-block pb-3">
                        ...
                        <div className="carousel-item">
                        <Link to={`/products/${highlights[2]._id}`}><img src={highlights[2].image_url} className="d-block w-50 h-25 mx-auto" alt={highlights[2].name} /></Link>
                        <div className="carousel-caption d-none d-md-block pb-3">
                ...
                <button className="carousel-control-prev" type="button" data-bs-target="#carouselHighlights"  data-bs-slide="prev">
                    <span className="carousel-control-prev-icon" style={{backgroundColor: 'rgba(0, 0, 0, 0.3)'}} aria-hidden="true"></span>
                    <span className="visually-hidden">Previous</span>
                </button>
                <button className="carousel-control-next" type="button" data-bs-target="#carouselHighlights"  data-bs-slide="next">
                    <span className="carousel-control-next-icon" style={{backgroundColor: 'rgba(0, 0, 0, 0.3)'}} aria-hidden="true"></span>
