...
export default function CategoriesTab({ activeTab }) {
  ...
  const handleAddCategorySubmit = async (e) => {
    ...
    try {
      ...
      status === 400 && toast.warning(error.response.data);
      setLoading(false);
      console.log(error);
    }
  };
  ...
  const handleUpdateCategorySubmit = async (e) => {
    ...
    try {
      ...
      setEditingCategory(false);
      const status = await error.response?.status;
      status && toast.warning(error.response.data);
      console.log(error);
    }
  };
          ...
          {editingCategory ? (
            <div>
              ...
              <form onSubmit={handleUpdateCategorySubmit}>
                ...
                <button
                  type="submit"
                  className="btn btn-outline-success border border-dark me-2"
                >
                  Confirm changes
                </button>
                <button
            ...
            <div>
              ...
              <form onSubmit={handleAddCategorySubmit}>
                ...
                <button
                  type="submit"
                  className="btn btn-outline-success border border-dark"
                >
                  Create
                </button>
              </form>
